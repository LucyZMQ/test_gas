  ...
  MultiOwnerLightAccount: {
    "v2.0.0": {
      ...
      address: toRecord<Chain, "id", { factory: Address; impl: Address }>(
        ...
        () => ({
          factory:
            "0xB32B9132463537566A12FB6459654bE15B960547".toLowerCase() as Address,
          impl: "0x9621B2c839Ad04393bcB1EF689cEb4cE2c4FE6D8".toLowerCase() as Address,
        })
      ),
      entryPointVersion: "0.7.0",
    },
...
export async function getLightAccountVersionDef<
  TAccount extends LightAccountBase
>(account: any, chain: Chain): Promise<AccountVersionDef> {
  ...
  const version =
    fromHex(implAddress, "bigint") === BigInt(0)
