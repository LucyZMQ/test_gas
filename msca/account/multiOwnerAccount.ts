...
import { getDefaultMultiOwnerModularAccountFactoryAddress } from "../utils";
import { standardExecutor } from "./standardExector";
...
export type CreateMultiOwnerModularAccountParams<
  TTransport extends Transport = Transport<any>,
  TSigner extends SmartAccountSigner = SmartAccountSigner,
